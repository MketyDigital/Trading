const ROLE_PERMISSIONS = Object.freeze({
  owner: new Set(['workspace.read', 'members.read', 'members.write', 'sources.read', 'sources.write']),
  admin: new Set(['workspace.read', 'members.read', 'members.write', 'sources.read', 'sources.write']),
