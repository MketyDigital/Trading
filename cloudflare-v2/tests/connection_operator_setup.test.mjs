...
test('connections UI exposes recommended Open API and Cloud Auto Trader with create, versioned download and identity sync actions', () => {
  ...
  assert.match(html, /https:\/\/github\.com\/MketyDigital\/Trading\/releases\/download\/ctrader-cbot-v1\.0\.0\/MketyCloudAutoTrader\.algo/);
});