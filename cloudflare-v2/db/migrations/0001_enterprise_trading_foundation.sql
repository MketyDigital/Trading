...
ALTER TABLE public.workspaces
    ...
    ADD COLUMN IF NOT EXISTS trading_access_enabled BOOLEAN NOT NULL DEFAULT FALSE,
    ADD COLUMN IF NOT EXISTS trading_required_role TEXT DEFAULT 'trading_access';

CREATE UNIQUE INDEX IF NOT EXISTS idx_workspaces_zitadel_org_id
    ON public.workspaces(zitadel_org_id)
